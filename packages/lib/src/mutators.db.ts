import type { client as edgedb_client } from '@repo/db/client'
import {
  create_todo_mutation,
  delete_todo_mutation,
  update_todo_mutation,
} from '@repo/db/mutations'
import type { fetch_client_group_query } from '@repo/db/queries'
import type { z } from 'zod'
import type { Mutation } from './mutation.types'
import { type ClientPushInfo } from './replicache.types'
